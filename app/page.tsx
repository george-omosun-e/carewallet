  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-teal-50 via-white to-coral-50 opacity-70"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in">
              <div className="inline-flex items-center space-x-2 bg-teal-100 text-teal-700 px-4 py-2 rounded-full text-sm font-semibold">
              ...
              <div className="flex items-center space-x-8 pt-4">
                <div>
                  <p className="text-3xl font-bold text-teal-600">R2.4M+</p>
                  <p className="text-sm text-gray-600">Funds raised</p>
                </div>
                <div>
                  <p className="text-3xl font-bold text-coral-600">1,200+</p>
            ...
            <div className="relative animate-slide-up">
              <div className="relative bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                <div className="absolute -top-4 -right-4 bg-coral-500 text-white px-6 py-3 rounded-full font-semibold shadow-lg">
                  R4,750 / R5,000
                </div>
                <div className="flex items-center space-x-4 mb-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-teal-400 to-coral-400 rounded-full"></div>
                  <div>
                ...
                <div className="mb-6">
                  <div className="h-3 bg-gray-200 rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-teal-500 to-coral-500" style={{ width: '95%' }}></div>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center justify-between p-4 bg-teal-50 rounded-xl">
                    ...
                    <span className="font-bold text-teal-600">R500</span>
                  </div>
                  <div className="flex items-center justify-between p-4 bg-coral-50 rounded-xl">
                    ...
                    <span className="font-bold text-coral-600">R1,000</span>
                  </div>
                </div>
      ...
      <section id="how-it-works" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center space-y-4 p-8 rounded-2xl hover:bg-teal-50 transition-colors">
              <div className="w-16 h-16 bg-gradient-to-br from-teal-400 to-teal-600 rounded-2xl mx-auto flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                1
              </div>
            ...
            <div className="text-center space-y-4 p-8 rounded-2xl hover:bg-coral-50 transition-colors">
              <div className="w-16 h-16 bg-gradient-to-br from-coral-400 to-coral-600 rounded-2xl mx-auto flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                2
              </div>
            ...
            <div className="text-center space-y-4 p-8 rounded-2xl hover:bg-teal-50 transition-colors">
              <div className="w-16 h-16 bg-gradient-to-br from-teal-400 to-coral-600 rounded-2xl mx-auto flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                3
              </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="#" className="hover:text-teal-400 transition-colors">How it Works</Link></li>
                <li><Link href="#" className="hover:text-teal-400 transition-colors">Pricing</Link></li>
                <li><Link href="#" className="hover:text-teal-400 transition-colors">For Pharmacies</Link></li>
              </ul>
            </div>
